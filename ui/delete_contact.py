...
# Form implementation generated from reading ui file 'ui/delete_contact.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/edit-delete.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Delete contact", None))
        self.esci.setText(_translate("Dialog", "Close", None))
        self.delete_2.setText(_translate("Dialog", "Delete", None))
