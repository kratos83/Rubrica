...
# Form implementation generated from reading ui file 'ui/update_contact.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/system-software-update.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        spacerItem = QtGui.QSpacerItem(510, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Update contact", None))
